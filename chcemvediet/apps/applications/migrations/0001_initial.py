...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'applications_application', (
            ...
            ('sender_email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=255)),
            ('recepient_email', self.gf('django.db.models.fields.EmailField')(max_length=255)),
        ))
