...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationDraft'
        db.create_table(u'applications_applicationdraft', (
        ...
        db.send_create_signal(u'applications', ['ApplicationDraft'])


    def backwards(self, orm):
        # Deleting model 'ApplicationDraft'
        db.delete_table(u'applications_applicationdraft')
    ...
    models = {
        u'applications.application': {
            ...
            'sender_email': ('django.db.models.fields.EmailField', [], {'unique': 'True', 'max_length': '255'}),
