...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Obligee.email'
        db.delete_column(u'obligees_obligee', 'email')

        # Adding field 'Obligee.emails'
        db.add_column(u'obligees_obligee', 'emails',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)

        # Adding field 'Obligee.status'
        db.add_column(u'obligees_obligee', 'status',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Obligee.email'
        db.add_column(u'obligees_obligee', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'Obligee.emails'
        db.delete_column(u'obligees_obligee', 'emails')

        # Deleting field 'Obligee.status'
        db.delete_column(u'obligees_obligee', 'status')
