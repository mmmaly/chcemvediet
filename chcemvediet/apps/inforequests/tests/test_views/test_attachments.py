...
class UploadAttachmentViewTest(CustomTestCase):
    ...
    def test_upload_file_uploads_file_and_attaches_it_to_user(self):
        ...
        self.assertEqual(attachment.generic_object, self.user1)
...
class DownloadAttachmentViewTest(CustomTestCase):
    ...
    def test_attachment_owned_by_another_user_returns_404_not_found(self):
    ...
    def test_attachment_owned_by_user_returns_200_ok(self):
