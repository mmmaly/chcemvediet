...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'History.inforequest'
        db.alter_column(u'inforequests_history', 'inforequest_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['inforequests.Inforequest']))
        # Deleting field 'Inforequest.history'
        db.delete_column(u'inforequests_inforequest', 'history_id')


    def backwards(self, orm):

        # Changing field 'History.inforequest'
        db.alter_column(u'inforequests_history', 'inforequest_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['inforequests.Inforequest']))
        # Adding field 'Inforequest.history'
        db.add_column(u'inforequests_inforequest', 'history',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'inforequest_', unique=True, null=True, to=orm['inforequests.History']),
                      keep_default=False)
