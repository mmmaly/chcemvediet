...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'History.advanced_by'
        db.add_column(u'inforequests_history', 'advanced_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'advanced_to_set', null=True, to=orm['inforequests.Action']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'History.advanced_by'
        db.delete_column(u'inforequests_history', 'advanced_by_id')
