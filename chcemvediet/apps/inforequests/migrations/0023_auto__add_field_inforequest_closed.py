...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inforequest.closed'
        db.add_column(u'inforequests_inforequest', 'closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inforequest.closed'
        db.delete_column(u'inforequests_inforequest', 'closed')
