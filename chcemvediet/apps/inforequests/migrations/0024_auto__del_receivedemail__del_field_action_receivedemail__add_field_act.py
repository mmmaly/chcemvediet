...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ReceivedEmail'
        db.delete_table(u'inforequests_receivedemail')

        # Deleting field 'Action.receivedemail'
        db.delete_column(u'inforequests_action', 'receivedemail_id')

        # Adding field 'Action.email'
        db.add_column(u'inforequests_action', 'email',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mail.Message'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding model 'ReceivedEmail'
        db.create_table(u'inforequests_receivedemail', (
            ('status', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('raw_email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_mailbox.Message'])),
            ('inforequest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inforequests.Inforequest'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'inforequests', ['ReceivedEmail'])

        # Adding field 'Action.receivedemail'
        db.add_column(u'inforequests_action', 'receivedemail',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['inforequests.ReceivedEmail'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Action.email'
        db.delete_column(u'inforequests_action', 'email_id')
    ...
    models = {
        ...
        u'inforequests.inforequest': {
            ...
            'undecided_set': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['mail.Message']", 'symmetrical': 'False'}),
