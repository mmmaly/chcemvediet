...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'History.obligee_zip'
        db.delete_column(u'inforequests_history', 'obligee_zip')

        # Deleting field 'History.obligee_city'
        db.delete_column(u'inforequests_history', 'obligee_city')

        # Deleting field 'History.obligee_street'
        db.delete_column(u'inforequests_history', 'obligee_street')

        # Deleting field 'History.obligee_name'
        db.delete_column(u'inforequests_history', 'obligee_name')

        # Adding field 'History.historicalobligee'
        db.add_column(u'inforequests_history', 'historicalobligee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['obligees.HistoricalObligee']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'History.obligee_zip'
        db.add_column(u'inforequests_history', 'obligee_zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'History.obligee_city'
        db.add_column(u'inforequests_history', 'obligee_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'History.obligee_street'
        db.add_column(u'inforequests_history', 'obligee_street',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'History.obligee_name'
        db.add_column(u'inforequests_history', 'obligee_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'History.historicalobligee'
        db.delete_column(u'inforequests_history', 'historicalobligee_id')
    ...
    models = {
        ...
        u'inforequests.history': {
            'Meta': {'ordering': "[u'historicalobligee__name', u'pk']", 'object_name': 'History'},
