...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.effective_date_new'
        db.add_column(u'inforequests_action', 'effective_date_new',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


        # Changing field 'Action.effective_date'
        db.alter_column(u'inforequests_action', 'effective_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'ActionDraft.effective_date_new'
        db.add_column(u'inforequests_actiondraft', 'effective_date_new',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Inforequest.submission_date_new'
        db.add_column(u'inforequests_inforequest', 'submission_date_new',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Inforequest.submission_date'
        db.alter_column(u'inforequests_inforequest', 'submission_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Action.effective_date_new'
        db.delete_column(u'inforequests_action', 'effective_date_new')


        # Changing field 'Action.effective_date'
        db.alter_column(u'inforequests_action', 'effective_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)))
        # Deleting field 'ActionDraft.effective_date_new'
        db.delete_column(u'inforequests_actiondraft', 'effective_date_new')

        # Deleting field 'Inforequest.submission_date_new'
        db.delete_column(u'inforequests_inforequest', 'submission_date_new')


        # Changing field 'Inforequest.submission_date'
        db.alter_column(u'inforequests_inforequest', 'submission_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2000, 1, 1, 0, 0)))
