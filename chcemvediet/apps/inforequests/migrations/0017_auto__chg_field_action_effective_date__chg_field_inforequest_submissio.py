...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inforequests_action', 'effective_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2000, 1, 1, 0, 0)))

        # Changing field 'Inforequest.submission_date'
        db.alter_column(u'inforequests_inforequest', 'submission_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2000, 1, 1, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Action.effective_date'
        db.alter_column(u'inforequests_action', 'effective_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Inforequest.submission_date'
        db.alter_column(u'inforequests_inforequest', 'submission_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
