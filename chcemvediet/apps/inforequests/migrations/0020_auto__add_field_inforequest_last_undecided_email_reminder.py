...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inforequest.last_undecided_email_reminder'
        db.add_column(u'inforequests_inforequest', 'last_undecided_email_reminder',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inforequest.last_undecided_email_reminder'
        db.delete_column(u'inforequests_inforequest', 'last_undecided_email_reminder')
