...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Action.effective_date_new' to 'Action.effective_date'
        db.rename_column(u'inforequests_action', 'effective_date_new', 'effective_date')

        # Renaming field 'ActionDraft.effective_date_new' to 'ActionDraft.effective_date'
        db.rename_column(u'inforequests_actiondraft', 'effective_date_new', 'effective_date')

        # Renaming field 'Inforequest.submission_date_new' to 'Inforequest.submission_date'
        db.rename_column(u'inforequests_inforequest', 'submission_date_new', 'submission_date')

    def backwards(self, orm):
        # Renaming field 'Action.effective_date' to 'Action.effective_date_new'
        db.rename_column(u'inforequests_action', 'effective_date', 'effective_date_new')

        # Renaming field 'ActionDraft.effective_date' to 'ActionDraft.effective_date_new'
        db.rename_column(u'inforequests_actiondraft', 'effective_date', 'effective_date_new')

        # Renaming field 'Inforequest.submission_date' to 'Inforequest.submission_date_new'
        db.rename_column(u'inforequests_inforequest', 'submission_date', 'submission_date_new')
    ...
    models = {
        ...
        u'inforequests.inforequest': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submission_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
