...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.last_deadline_expiration_reminder'
        db.add_column(u'inforequests_action', 'last_deadline_expiration_reminder',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.last_deadline_expiration_reminder'
        db.delete_column(u'inforequests_action', 'last_deadline_expiration_reminder')
    ...
    models = {
        ...
        u'inforequests.action': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_deadline_expiration_reminder': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
