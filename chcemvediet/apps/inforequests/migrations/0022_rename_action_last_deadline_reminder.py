...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Action.last_deadline_expiration_reminder' to 'Action.last_deadline_reminder'
        db.rename_column(u'inforequests_action', 'last_deadline_expiration_reminder', 'last_deadline_reminder')

    def backwards(self, orm):
        # Renaming field 'Action.last_deadline_reminder' to 'Action.last_deadline_expiration_reminder'
        db.rename_column(u'inforequests_action', 'last_deadline_reminder', 'last_deadline_expiration_reminder')
