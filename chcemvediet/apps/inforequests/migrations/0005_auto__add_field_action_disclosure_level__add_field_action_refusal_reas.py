...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.disclosure_level'
        db.add_column(u'inforequests_action', 'disclosure_level',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Action.refusal_reason'
        db.add_column(u'inforequests_action', 'refusal_reason',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.disclosure_level'
        db.delete_column(u'inforequests_action', 'disclosure_level')

        # Deleting field 'Action.refusal_reason'
        db.delete_column(u'inforequests_action', 'refusal_reason')
