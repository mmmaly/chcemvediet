...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Action.effective_date'
        db.delete_column(u'inforequests_action', 'effective_date')

        # Deleting field 'ActionDraft.effective_date'
        db.delete_column(u'inforequests_actiondraft', 'effective_date')

        # Deleting field 'Inforequest.submission_date'
        db.delete_column(u'inforequests_inforequest', 'submission_date')


    def backwards(self, orm):
        # Adding field 'Action.effective_date'
        db.add_column(u'inforequests_action', 'effective_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ActionDraft.effective_date'
        db.add_column(u'inforequests_actiondraft', 'effective_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Inforequest.submission_date'
        db.add_column(u'inforequests_inforequest', 'submission_date',
