...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.extension'
        db.add_column(u'inforequests_action', 'extension',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.extension'
        db.delete_column(u'inforequests_action', 'extension')
