...
class CronJobTest(TestCase):
    ...
    def _call_runcrons(self, mock_logs=(), expected_call_count=0, expected_logs=[], **cron_kwargs):
        mock_call = mock.Mock()
        ...
        with mock.patch(u'poleno.cron.tests.test_cron.mock_cron_job', mock_cron_job):
            with self.settings(CRON_CLASSES=(u'poleno.cron.tests.test_cron.mock_cron_job',)):
